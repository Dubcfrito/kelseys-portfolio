...
video_folders=(
  ...
  "portfolio-materials/Storyboarding"
...
echo ""
echo "📝 Next steps:"
echo "   1. Run 'python json_gen.py' to update JSON files"
#!/bin/bash
...
echo "📝 Next steps:"
echo "   1. Run 'python json_gen.py' to update JSON files"
echo "   2. Refresh your website to see the changes"echo "   2. Refresh your website to see the changes"